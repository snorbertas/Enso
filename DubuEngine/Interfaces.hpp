 ...
 */
	void RenderInterfaces(Game* g,
		MoreSprites* spritos,				// Pointer to sprites
...
/* =========================== DrawSkillToolTip ===========================
 *		Draws a tooltip for a skill/ability.
 *		The x/y values are the cursor's position.
 *
 *		Called when hovering over skills/abilities.
 */
	void DrawSkillTooltip(Game *g,
		ALLEGRO_FONT** font,
		Ability* a);						// Ability pointer
